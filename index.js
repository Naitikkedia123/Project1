...
app.post('/post/new', upload.single('image'), (req, res) => {
    ...
    home.push({ username, content, id, like: 0,dislike: 0, image, Comment: [], name: [] });
    post.push({ username, content, id, like: 0,dislike: 0, image, Comment: [], name: [] });
    newPost.push({ username, content, id, like: 0,dislike: 0,image, Comment: [], name: [] });
    res.redirect('/post');
});
